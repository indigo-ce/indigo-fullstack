...
import { Html, Body, Container, Head, Hr, Text, Section, Heading } from '@react-email/components';
...
const BaseLayout = ({ children, title = "Astro Starter" }: BaseLayoutProps) => {
  console.log("BaseLayout rendering with title:", title);
  
  return (
    <Html>
      <Head />
      <Body style={{ fontFamily: 'sans-serif', margin: '0', padding: '0' }}>
        <Container style={{ maxWidth: '600px', margin: '0 auto', border: '1px solid #efefef', padding: '16px' }}>
          {/* Header */}

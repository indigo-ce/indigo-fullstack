...
const translations = {
  en: {
    ...
    body2:
      "If you didn't make this request, you can safely ignore this email. Otherwise, click the link below to reset your password:",
  ...
  ja: {
    ...
    body2:
      "このリクエストを行っていない場合は、このメールを無視してください。それ以外の場合は、以下のリンクをクリックしてパスワードをリセットしてください。",
    button: "パスワードをリセット",
...
const PasswordReset = ({
  ...
  return (
    <BaseLayout title={t.title}>
      ...
      <Text style={{marginBottom: "16px"}}>{t.body1}</Text>
      <Text style={{marginBottom: "16px"}}>{t.body2}</Text>
      <Text>
        <a
          href={resetLink}

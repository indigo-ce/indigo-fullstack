...
const WelcomeEmail = ({name}: WelcomeEmailProps) => {
  ...
  return (
    <BaseLayout title="Welcome to Indigo CE">
      <Text style={{marginBottom: "16px"}}>Hi, {safeName},</Text>
      <Text style={{marginBottom: "16px"}}>Welcome to Indigo CE!</Text>
      <Text>
        Thank you for joining us. We're excited to have you on board and look
        forward to helping you build amazing projects with Indigo CE.
      </Text>
    </BaseLayout>
  );
};
